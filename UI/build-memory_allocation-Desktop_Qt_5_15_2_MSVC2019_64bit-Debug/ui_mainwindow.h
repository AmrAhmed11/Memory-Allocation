...
"}"));
        ...
        gridLayout_2->addWidget(segments_table, 32, 0, 2, 1);
...
"}"));
        ...
        segments_number_button->setFont(font2);
...
"}"));
        ...
        Enter_Hole_button->setFont(font2);
...
"}"));
        ...
        gridLayout_2->addWidget(Allocation_Method, 26, 0, 1, 2);
...
"}"));
        ...
        gridLayout_2->addWidget(Allocation_Method_Button, 27, 0, 1, 2);
